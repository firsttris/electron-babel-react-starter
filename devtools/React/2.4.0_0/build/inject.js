!function(modules) {
    ...
    "use strict";
    var installGlobalHook = __webpack_require__(1), installRelayHook = __webpack_require__(2);
    window.addEventListener("message", function(evt) {
        evt.source === window && evt.data && "react-devtools-detector" === evt.data.source && chrome.runtime.sendMessage({
            hasDetectedReact: !0,
